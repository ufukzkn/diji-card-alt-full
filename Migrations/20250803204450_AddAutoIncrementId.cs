...
namespace diji_card_alt_full.Migrations
{
    ...
    public partial class AddAutoIncrementId : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Bu sütunlar zaten silinmiş, tekrar silmeye gerek yok
            // migrationBuilder.DropColumn(name: "CardLayout", table: "Users");
            // migrationBuilder.DropColumn(name: "FontFamily", table: "Users");  
            // migrationBuilder.DropColumn(name: "ThemeColor", table: "Users");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDefinitionValues_UserId_CustomDefinitionName",
                table: "UserDefinitionValues",
                columns: new[] { "UserId", "CustomDefinitionName" },
                unique: true,
                filter: "[CustomDefinitionName] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[CustomDefinitionName] IS NULL");
